...
st.title('🎁 Animated GIF Maker From Video')

## Upload file ##
st._main.header('Upload file')

with st.container(height=200):
    
    
    uploaded_file = st._main.file_uploader("Choose a file", type=['mov', 'mp4'])
...
st._bottom.markdown('''
Made by Divya Kolsure ([Detail](https://github.com/Chaganti-Reddy))
''')
